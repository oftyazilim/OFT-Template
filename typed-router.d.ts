...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'components-card-esd': RouteRecordInfo<'components-card-esd', '/components/CardEsd', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-dashboard-esd': RouteRecordInfo<'dashboards-dashboard-esd', '/dashboards/dashboard-esd', Record<never, never>, Record<never, never>>,
    'dashboards-dashboard-ytk': RouteRecordInfo<'dashboards-dashboard-ytk', '/dashboards/dashboard-ytk', Record<never, never>, Record<never, never>>,
