...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'components-montaj': RouteRecordInfo<'components-montaj', '/components/montaj', Record<never, never>, Record<never, never>>,
    ...
    'dashboards-montaj-ytk': RouteRecordInfo<'dashboards-montaj-ytk', '/dashboards/montaj-ytk', Record<never, never>, Record<never, never>>,
    'dashboards-montaj-ytk copy': RouteRecordInfo<'dashboards-montaj-ytk copy', '/dashboards/montaj-ytk copy', Record<never, never>, Record<never, never>>,
    ...
    'planlama-mamulkartlari copy 2': RouteRecordInfo<'planlama-mamulkartlari copy 2', '/planlama/mamulkartlari copy 2', Record<never, never>, Record<never, never>>,
    ...
    'planlama-uretimgirisleri copy': RouteRecordInfo<'planlama-uretimgirisleri copy', '/planlama/uretimgirisleri copy', Record<never, never>, Record<never, never>>,
    'register': RouteRecordInfo<'register', '/register', Record<never, never>, Record<never, never>>,
    'stoklar-modal': RouteRecordInfo<'stoklar-modal', '/stoklar/Modal', Record<never, never>, Record<never, never>>,
    'stoklar-my-modal': RouteRecordInfo<'stoklar-my-modal', '/stoklar/MyModal', Record<never, never>, Record<never, never>>,
    'stoklar-stok-kalite2-s': RouteRecordInfo<'stoklar-stok-kalite2-s', '/stoklar/stok-kalite2-s', Record<never, never>, Record<never, never>>,
