    ...
    <VRow>
      <VCard>
        ...
        <DxDataGrid id="gridContainer" key-expr="id" ref="dataGridRef" @content-ready="onContentReady"
          ...
          <DxColumn data-field="adet2" caption="GERÇEK AD" data-type="number" :visible="true" />
          <DxColumn data-field="kantarkg" caption="GERÇEK KG" data-type="number" />
          ...
          <DxColumn data-field="nevi" caption="NEVİ" data-type="string" />
          ...
          <DxColumn data-field="hat" caption="HAT" data-type="string" :visible="true" />
...
var sayilanlar = 3
var mesaj = 'Şekerpınar 2. Kalite Stok: '
...
const getData = () => {
  axios
    ...
    .then((response) => {
      ...
      if (sayilanlar == 3) mesaj = 'Şekerpınar 2. Kalite Stok: '
      else if (sayilanlar === 1) mesaj = 'Şekerpınar 2. Kalite (Sayılanlar)'
      else mesaj = 'Şekerpınar 2. Kalite (Sayılmayanlar)'
      sayilanlar = 3
...
const onExporting = (e: DxDataGridTypes.ExportingEvent) => {
  ...
  const worksheet = workbook.addWorksheet("StokKalite2SPinar");
