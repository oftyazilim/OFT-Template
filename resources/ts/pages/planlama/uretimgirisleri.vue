<template>
  <div id="data-grid-demo">
    <DxDataGrid :data-source="employees" :show-borders="true" key-expr="ID" @editor-preparing="onEditorPreparing">
      <DxEditing :allow-updating="true" :allow-adding="true" mode="popup" />
      <DxColumn data-field="FirstName" />
      <DxColumn data-field="LastName" />
      <DxColumn data-field="Position" />
      <DxColumn :set-cell-value="setStateValue" data-field="StateID" caption="State">
        <DxLookup :data-source="states" display-expr="Name" value-expr="ID" />
      </DxColumn>
      <DxColumn data-field="CityID" caption="City">
